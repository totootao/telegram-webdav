...
| 用例 | 结果 | 说明 |
|---|---|---|
| put.big.multi_chunk | PASS | status=201 chunks=5 put=4.18s |
...
| concurrent.diff_files.all_200_and_identical | PASS | errors={} ok=4/4 wall=0.57s |
| concurrent.parallelism_preserved | PASS | wall=0.57s 单文件基准≈0.45s (4路并发墙钟应接近单文件基准,证明服务端层并发未被串行化) |
