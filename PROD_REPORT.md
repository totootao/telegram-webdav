...
| 指标 | 数值 |
|---|---|
| 上传 60MB | 6.80s (8.82 MB/s) |
| 全量下载 | 8.50s (7.06 MB/s) |
| 起播吞吐 | 23.61 MB/s |
| seek 吞吐 | 19.30 MB/s |
| 平均吞吐 | 15.33 MB/s |
...
|---|---|---|---|---|---|---|
| 起播 bytes=0- | 357ms | 355ms | 3ms | 2次 | 0次 | 23.61MB/s |
| seek 60% | 353ms | 352ms | 3ms | 1次 | 0次 | 19.30MB/s |
| 全量(无Range) | 5713ms | 361ms | 6ms | 2次 | 0次 | 7.06MB/s |
...
| concurrent.ranges.all_206 | PASS | ok=4/4 err={} wall=4.31s |
